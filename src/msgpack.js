...
Decoder.prototype.parse = function () {
	...
	switch (type) {
		...
		case 0xc7:
			...
			this.offset += 3;
			return [extType, this.buf(length)];
		// ext 16
		case 0xc8:
			length = this.view.getUint16(this.offset + 1);
		...
		case 0xd5:
			extType = this.view.getUint8(this.offset + 1);
			this.offset += 2;
			return [extType, this.buf(2)];
		// fixext 4
		case 0xd6:
			extType = this.view.getUint8(this.offset + 1);
			this.offset += 2;
			return [extType, this.buf(4)];
		// fixext 8
		case 0xd7:
			extType = this.view.getUint8(this.offset + 1);
			this.offset += 2;
			return [extType, this.buf(8)];
		// fixext 16
		case 0xd8:
			extType = this.view.getUint8(this.offset + 1);
			this.offset += 2;
			return [extType, this.buf(16)];
		// str 8
		case 0xd9:
			length = this.view.getUint8(this.offset + 1);
			this.offset += 2;
...
function encode(value, view, offset) {
	var type = typeof value, length, size, isArray, i;
...
function sizeof(value) {
	var type = typeof value, length, size, keys, i;
	...
	if (type === "object") {
		...
		if (Array.isArray(value)) {
			...
			length = keys.length;
			for (i = 0; i < length; i++) {
				size += sizeof(keys[i]) + sizeof(value[keys[i]]);
			}
		}
		if (length < 0x10) {
			return 1 + size;
